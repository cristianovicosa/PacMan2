 ...
 */
public class PacmanBase_fase3 extends base.Jogo {

    //Objeto para armazenar o PNG do pacman.
    BufferedImage pacman, bloco, pilula, pilula1, pilula2, fantasma,fantasma1,fantasma2,pilulaEsp;
    ...
    public static void main(String[] args) {
        base.JogoApp.inicia(new PacmanBase_fase3());
    }
    ...
    public PacmanBase_fase3() {
        ...
        try {
            ...
            pilula = pilula2;
            pilulaEsp = ImageIO.read(new File("resources/imagens/moEsp.png"));
        } catch (IOException ex) {
        ...
        Scanner s;
        try {
            s = new Scanner(new File("resources/mapas/mapaGrande.txt"));
            mapa = new ArrayList<>();
            while (s.hasNextLine()) {
                mapa.add(s.next());
            }
        ...
        for (int i = 0; i < totalLinhas; i++) {
            for (int j = 0; j < totalColunas; j++) {
                if(charAt(i, j)=='1'){
                    ...
                    if (passei[i][j] == false && (charAt(i, j)== '2'||charAt(i, j)== '3')){
                        g.drawImage(pilula,j*TAM,i*TAM,TAM,TAM,null);
                    }
                    if (passei[i][j] == false && (charAt(i, j)== '6')){
                        g.drawImage(pilulaEsp,j*TAM,i*TAM,TAM,TAM,null);
                    }
                }                
            }
        }
